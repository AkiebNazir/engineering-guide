...
Even with <abbr title="Quantized Low-Rank Adaptation">QLoRA</abbr>, if you have a massive batch size, you might OOM the GPU. 
<abbr title="Quantized Low-Rank Adaptation">QLoRA</abbr> introduced **Paged Optimizers**. Similar to how your computer's OS pages RAM to your SSD when you open too many Chrome tabs, NVIDIA Unified Memory will temporarily page the Adam Optimizer states out of the GPU VRAM and into your cheap CPU System RAM!
