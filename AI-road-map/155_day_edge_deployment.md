...
If you run this on an M2 Macbook Air, you will get around 15-20 tokens per second. The text will stream across your screen smoothly, completely disconnected from the internet, using only 4.5GB of RAM, and without melting your laptop. This is the power of GGUF and `llama.cpp`.
