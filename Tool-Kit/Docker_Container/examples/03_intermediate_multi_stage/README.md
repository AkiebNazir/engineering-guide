# 03 Intermediate Multi Stage

**Goal:** Demonstrate 03 intermediate multi stage
...
2. Build the image:
   ```bash
   docker build -t 03_intermediate_multi_stage .
   ```
3. Run the container:
   ```bash
   docker run -p 8080:8080 03_intermediate_multi_stage
   ```
