# 03 Intermediate Go Multistage

**Goal:** Demonstrate 03 intermediate go multistage
...
2. Build the image:
   ```bash
   docker build -t 03_intermediate_go_multistage .
   ```
3. Run the container:
   ```bash
   docker run -p 8080:8080 03_intermediate_go_multistage
   ```
