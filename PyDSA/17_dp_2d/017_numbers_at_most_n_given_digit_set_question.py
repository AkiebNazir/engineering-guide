...
# ==============================================================================
# TESTS — run:  python 017_numbers_at_most_n_given_digit_set_question.py
# ==============================================================================
def run_tests() -> None:
    cases = [
        (["1", "3", "5", "7"], 100, 20),
    ...
    for digits, n, want in cases:
        got = Solution().atMostNGivenDigitSet(digits, n)
        ok = got == want
        all_ok &= ok
        print(f"{'PASS' if ok else 'FAIL'}  digits={digits} n={n}  got={got}  want={want}")
