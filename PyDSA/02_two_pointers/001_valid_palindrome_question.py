...
# ==============================================================================
# TESTS — run:  python 001_valid_palindrome_question.py
# ==============================================================================
def run_tests() -> None:
    sol = Solution()
    cases = [
        ...
        ("", True),                        # empty input
        (".,;:!", True),                   # ALL junk — the skip-loop killer
        ("a", True),                       # single character
        ("ab", False),
        ("aa", True),
        ("0P", False),                     # '0' vs 'p' — the ord() trap
        ("aba", True),                     # odd length, middle ignored
    ...
    for s, expected in cases:
        ...
        ok = got == expected
        passed += ok
        print(f"{'PASS' if ok else 'FAIL'}  {s!r:<34} -> {got} (want {expected})")
