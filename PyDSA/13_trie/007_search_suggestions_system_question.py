...
# ==============================================================================
# TESTS — run:  python 007_search_suggestions_system_question.py
# ==============================================================================
def run_tests() -> None:
    cases = [
    ...
    for products, word, want in cases:
        got = Solution().suggestedProducts(list(products), word)
        ok = got == want
        all_ok &= ok
        print(f"{'PASS' if ok else 'FAIL'}  word={word!r}  got={got}")
