...
# ==============================================================================
# TESTS — run:  python 010_design_search_autocomplete_system_question.py
# ==============================================================================
def run_tests() -> None:
    all_ok = True
    ...
    ops = [
        (sys_.input("i"), ["i love you", "island", "i love leetcode"]),
        (sys_.input(" "), ["i love you", "i love leetcode"]),
        (sys_.input("a"), []),
        (sys_.input("#"), []),
    ]
    for got, want in ops:
    ...
    # The sentence typed and terminated with '#' above ("i a") should now
    # be findable on a fresh search for prefix "i a".
    ok = True
    for ch in "i a":
        result = sys_.input(ch)
    ok = "i a" in result
    all_ok &= ok
    print(f"{'PASS' if ok else 'FAIL'}  newly typed-and-saved sentence 'i a' is now suggestible")
