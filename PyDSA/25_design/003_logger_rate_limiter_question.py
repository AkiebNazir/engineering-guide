...
# ==============================================================================
# TESTS — run:  python 003_logger_rate_limiter_question.py
# ==============================================================================
def run_tests() -> None:
    all_ok = True
    ...
    # Same timestamp, two different messages: both allowed.
    l2 = Logger()
    ok = l2.shouldPrintMessage(5, "a") is True and l2.shouldPrintMessage(5, "b") is True
    all_ok &= ok
    print(f"{'PASS' if ok else 'FAIL'}  different messages at the same timestamp both allowed")
