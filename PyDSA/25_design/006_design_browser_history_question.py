...
# ==============================================================================
# TESTS — run:  python 006_design_browser_history_question.py
# ==============================================================================
def run_tests() -> None:
    all_ok = True
    ...
    # back()/forward() beyond the available range clamp instead of erroring.
    bh2 = BrowserHistory("a.com")
    ok = bh2.back(100) == "a.com" and bh2.forward(100) == "a.com"
    all_ok &= ok
    print(f"{'PASS' if ok else 'FAIL'}  back/forward beyond range clamp to the boundary page")
