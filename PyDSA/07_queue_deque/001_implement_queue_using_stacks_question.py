...
# ==============================================================================
# TESTS — run:  python 001_implement_queue_using_stacks_question.py
# ==============================================================================
def run_tests() -> None:
    passed = 0
    total = 0
    ...
    for x in (5, 6, 7, 8):
        q2.push(x)
    check("interleaved order", [q2.pop(), q2.pop(), q2.pop(), q2.pop()], [5, 6, 7, 8])

    q3 = MyQueue()
    q3.push(1)
    q3.push(2)
    check("pop 1", q3.pop(), 1)
    q3.push(3)
    check("pop 2 (interleaved push mid-drain)", q3.pop(), 2)
    check("pop 3", q3.pop(), 3)
