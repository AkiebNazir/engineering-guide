...
# ==============================================================================
# TESTS — run:  python 003_number_of_recent_calls_question.py
# ==============================================================================
def run_tests() -> None:
    passed = 0
    total = 0
    ...
    check("ping(3002)", rc.ping(3002), 3)   # 1 falls out: 1 < 3002-3000=2

    rc2 = RecentCounter()
    check("boundary: ping(3000)", rc2.ping(3000), 1)
    check("boundary: ping(6000)", rc2.ping(6000), 2)   # 3000 >= 6000-3000=3000, kept (inclusive)
    check("boundary: ping(6001)", rc2.ping(6001), 2)   # 3000 < 6001-3000=3001, evicted
