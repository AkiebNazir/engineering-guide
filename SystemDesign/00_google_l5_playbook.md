...
| Email | SMTP ingest and the spam pipeline; mailbox storage; per-user search; sync cursors; deliverability. | [08](building_blocks/08_object_storage.md), [09](building_blocks/09_messaging_and_streaming.md) · [041](problems/041_email_service_question.md) |
...
The problem number after the · is the practice problem to attempt against the clock; the [catalog](02_problem_catalog.md) lists all 41. Company-specific emphasis is in the [company interview guide](01_company_interview_guide.md).
