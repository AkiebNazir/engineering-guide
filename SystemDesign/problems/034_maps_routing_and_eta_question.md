...
- **Routing <abbr title="Service Level Objective - A specific target level for the reliability of a service, usually defined by a numerical goal for a metric.">SLO</abbr>:** 5,000 route requests per second at peak (previews, starts, re-routes), p99 under 300 ms end to end for routes up to 3,000 km, and 99.95% availability.
