...
- Removed: `commonjs` <abbr title="Application Programming Interface">API</abbr>. In supported Node versions `require(esm)` will work without needing to make code changes.
