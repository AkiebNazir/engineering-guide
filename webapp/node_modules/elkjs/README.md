...
that provides a wrapper around node's `worker_threads`, which is <abbr title="Application Programming Interface">API</abbr>-compatible to a browser's `Worker.
...
* [@EyMaddis](https://github.com/EyMaddis) for valuable <abbr title="Application Programming Interface">API</abbr> discussions
