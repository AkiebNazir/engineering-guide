...
* `'ERR_INVALID_PACKAGE_CONFIG'`
  — when a `package.json` is invalid (example: invalid <abbr title="JavaScript Object Notation - A lightweight data-interchange format that is easy for humans to read/write and machines to parse/generate.">JSON</abbr>)
...
* no support for <abbr title="Command-Line Interface. A text-based user interface used to view and manage computer files.">CLI</abbr> flags:
  `--conditions`,
