...
Like the async <abbr title="Application Programming Interface">API</abbr>, you can iterate over lines:
...
Since the synchronous <abbr title="Application Programming Interface">API</abbr> blocks the event loop, there are some features that are supported in the async <abbr title="Application Programming Interface">API</abbr> that the sync <abbr title="Application Programming Interface">API</abbr> does not support:
...
following <abbr title="Application Programming Interface">API</abbr> methods and properties available:
...
`child_process` <abbr title="Application Programming Interface">API</abbr>.
