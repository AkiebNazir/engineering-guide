...
The main <abbr title="Application Programming Interface">API</abbr> is provided by the [`URL`](https://url.spec.whatwg.org/#url-class) and [`URLSearchParams`](https://url.spec.whatwg.org/#interface-urlsearchparams) exports, which follows the spec's behavior in all ways (including e.g. `USVString` conversion). Most consumers of this library will want to use these.

### Low-level URL Standard <abbr title="Application Programming Interface">API</abbr>
...
The URL record type has the following <abbr title="Application Programming Interface">API</abbr>:
