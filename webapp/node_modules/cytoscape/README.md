 ...
 * `test:js` : run the mocha tests on the public <abbr title="Application Programming Interface">API</abbr> of the lib (directly on source files)
   * `npm run test:js -- -g "my test name"` runs tests on only the matching test cases
 * `test:build` : run the mocha tests on the public <abbr title="Application Programming Interface">API</abbr> of the lib (on a built bundle) 
 ...
 * `test:modules` : run unit tests on private, internal <abbr title="Application Programming Interface">API</abbr>
