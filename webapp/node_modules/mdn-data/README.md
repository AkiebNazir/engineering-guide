...
Inside each of these directories is one or more <abbr title="JavaScript Object Notation - A lightweight data-interchange format that is easy for humans to read/write and machines to parse/generate.">JSON</abbr> files containing the data.

### api

Contains data about Web APIs:

- <abbr title="Application Programming Interface">API</abbr> inheritance (interface inheritance and mixin implementations)
