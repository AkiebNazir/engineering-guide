...
A SOCKS5 proxy wrapper class that implements the Dispatcher <abbr title="Application Programming Interface">API</abbr>. It enables HTTP requests to be routed through a SOCKS5 proxy server, providing connection tunneling and authentication support.
