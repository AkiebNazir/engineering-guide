...
A Proxy Agent class that implements the Agent <abbr title="Application Programming Interface">API</abbr>. It allows the connection through proxy in a simple way.
...
#### Example - ProxyAgent with <abbr title="Hypertext Transfer Protocol Secure - An extension of HTTP that uses encryption for secure communication over a computer network.">HTTPS</abbr> Tunneling

This example demonstrates how to perform <abbr title="Hypertext Transfer Protocol Secure - An extension of HTTP that uses encryption for secure communication over a computer network.">HTTPS</abbr> tunneling using a proxy.
