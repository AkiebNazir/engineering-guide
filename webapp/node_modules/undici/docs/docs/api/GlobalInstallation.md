...
| Class | Description |
|-------|-------------|
| `fetch` | The fetch function for making <abbr title="Hypertext Transfer Protocol - The foundation of data communication for the World Wide Web, operating on a client-server model.">HTTP</abbr> requests |
