...
The `SnapshotAgent` provides a powerful way to record and replay <abbr title="Hypertext Transfer Protocol - The foundation of data communication for the World Wide Web, operating on a client-server model.">HTTP</abbr> requests for testing purposes. It extends `MockAgent` to enable automatic snapshot testing, eliminating the need to manually define mock responses.

## Use Cases

- **Integration Testing**: Record real <abbr title="Application Programming Interface">API</abbr> interactions and replay them in tests
...
- **<abbr title="Application Programming Interface">API</abbr> Contract Testing**: Capture and validate <abbr title="Application Programming Interface">API</abbr> behavior over time
...
#### Record Mode (`'record'`)
Makes real <abbr title="Hypertext Transfer Protocol - The foundation of data communication for the World Wide Web, operating on a client-server model.">HTTP</abbr> requests and saves the responses to snapshots.
...
Replays recorded responses without making real <abbr title="Hypertext Transfer Protocol - The foundation of data communication for the World Wide Web, operating on a client-server model.">HTTP</abbr> requests.
...
Snapshots are stored as <abbr title="JavaScript Object Notation - A lightweight data-interchange format that is easy for humans to read/write and machines to parse/generate.">JSON</abbr> with the following structure:
...
- ✅ Add snapshot files to `.gitignore` if they contain real <abbr title="Application Programming Interface">API</abbr> data
