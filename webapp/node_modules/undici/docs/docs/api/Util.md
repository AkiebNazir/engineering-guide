...
Utility <abbr title="Application Programming Interface">API</abbr> for third-party implementations of the dispatcher <abbr title="Application Programming Interface">API</abbr>.
