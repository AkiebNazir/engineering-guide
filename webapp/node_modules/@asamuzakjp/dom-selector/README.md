...
[64]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Element/matches
[65]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Element/closest
[66]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Document/querySelector
[67]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/DocumentFragment/querySelector
[68]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Element/querySelector
[69]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Document/querySelectorAll
[70]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/DocumentFragment/querySelectorAll
[71]: https://developer.mozilla.org/docs/Web/<abbr title="Application Programming Interface">API</abbr>/Element/querySelectorAll
