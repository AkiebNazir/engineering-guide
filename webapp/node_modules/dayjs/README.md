...
<p align="center"><a href="https://day.js.org/" target="_blank" rel="noopener noreferrer"><img width="550"
                                                                             ...
                                                                             alt="Day.js" /></a></p>
<p align="center">Fast <b>2kB</b> alternative to Moment.js with the same modern <abbr title="Application Programming Interface">API</abbr></p>
<p align="center">
...
> Day.js is a minimalist JavaScript library that parses, validates, manipulates, and displays dates and times for modern browsers with a largely Moment.js-compatible <abbr title="Application Programming Interface">API</abbr>. If you use Moment.js, you already know how to use Day.js.

```js
dayjs().startOf('month').add(1, 'day').set('year', 2018).format('YYYY-MM-DD HH:mm:ss');
```

* 🕒 Familiar Moment.js <abbr title="Application Programming Interface">API</abbr> & patterns
* 💪 Immutable
* 🔥 Chainable
* 🌐 I18n support
* 📦 2kb mini library
...
You can find more details, <abbr title="Application Programming Interface">API</abbr>, and other docs on [day.js.org](https://day.js.org/) website.
