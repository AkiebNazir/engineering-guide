...
const SD_LABS = {
  ...
  'building_blocks/06_database_internals': [['sd-lsm', /storage engine/i], ['sd-shard', /partitioning/i], ['sd-quorum', /replication modes/i], ['sd-raft', /consensus/i]],
  'building_blocks/07_caching': [['sd-cache', /stampede/i]],
  'building_blocks/09_messaging_and_streaming': [['sd-kafka', /ordering scope|visibility/i]],
  ...
  'building_blocks/26_distributed_log_internals': [['sd-quorum', /replication/i], ['sd-kafka', /consumer groups/i]],
  ...
  'building_blocks/29_cdn_and_streaming_media': [['sd-cache', /what a cdn is/i]],
