...
Level 08 covers the opposite instinct from this whole level's flexibility: how to opt back into enforced structure with a JSON Schema validator, and when that tradeoff is worth making.
