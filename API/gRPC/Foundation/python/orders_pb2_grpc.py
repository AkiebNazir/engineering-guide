...
class OrderServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CreateOrder = channel.unary_unary(
                '/foundation.orders.v1.OrderService/CreateOrder',
...
def add_OrderServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'foundation.orders.v1.OrderService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('foundation.orders.v1.OrderService', rpc_method_handlers)
