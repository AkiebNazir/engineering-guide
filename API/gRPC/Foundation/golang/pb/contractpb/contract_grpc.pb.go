...
const (
	Greeter_Ping_FullMethodName    = "/foundation.contract.v1.Greeter/Ping"
	Greeter_Version_FullMethodName = "/foundation.contract.v1.Greeter/Version"
)
...
func (c *greeterClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Greeter_Version_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_Version_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foundation.contract.v1.Greeter",
